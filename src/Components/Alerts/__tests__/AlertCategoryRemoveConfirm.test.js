...
import AlertCategoryRemoveConfirm from "Components/Alerts/AlertCategoryRemoveConfirm";

const props = { onClose: jest.fn(), onRemove: jest.fn() };

describe("'AlertCategoryRemoveConfirm' component", () => {
  const wrapper = shallow(<AlertCategoryRemoveConfirm {...props} />);
  ...
  it("'ConfirmModal' component should contain propre 'title' and 'body' props", () => {
    const desiredProps = {
      ...
      body:
        "All yours data belonging to this category, like subjects and records will be permanently removed. Are you sure?",
    };
